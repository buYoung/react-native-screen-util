...
export type ResponsiveMarginParam<
    T =
        | ResponsiveMarginParamOriginal
        | ResponsiveMarginParamOriginalHorizontalVertical
        | ResponsiveMarginParamOriginalAll
        | ResponsiveMarginParamWord
        | ResponsiveMarginParamWordAll
        | ResponsiveMarginParamWordhv
> = T;
